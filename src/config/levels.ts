...
export const LEVELS: LevelConfig[] = [
  ...
  // Paperboy
  { id: 'paperboy_normal',universeId:'paperboy',type: 'normal', name: 'Tournée du Matin',    mechanic: 'deliveryTargets',   quota: 8,  speedMs: 145, ruleText: 'LIVRAISON',                 introHint: 'Livre les bonnes maisons sans te crasher.', mapNodeId: 'node_15' },
