...
export type RuntimeAssetRole = "pickup" | "pickupSecondary" | "obstacle" | "boss";
...
export const RUNTIME_UNIVERSE_ASSETS: Record<string, UniverseRuntimeAssetSet> = {
  sonic: {
    ...
    pickupSecondary: publicAsset("assets/runtime/universes/sonic/pickup_secondary.png"),
  ...
  streets: {
    ...
    pickupSecondary: publicAsset("assets/runtime/universes/streets/pickup_secondary.png"),
  ...
  fighter: {
    ...
    pickupSecondary: publicAsset("assets/runtime/universes/fighter/pickup_secondary.png"),
  ...
  outrun: {
    ...
    pickupSecondary: publicAsset("assets/runtime/universes/outrun/pickup_secondary.png"),
  ...
  shinobi: {
    ...
    pickupSecondary: publicAsset("assets/runtime/universes/shinobi/pickup_secondary.png"),
  ...
  kombat: {
    ...
    pickupSecondary: publicAsset("assets/runtime/universes/kombat/pickup_secondary.png"),
  ...
  paperboy: {
    ...
    pickupSecondary: publicAsset("assets/runtime/universes/paperboy/pickup_secondary.png"),
